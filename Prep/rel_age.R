### Data Prep: Recode age data in Fresno RIPA data to reflect age-brackets that align with Census data###
...
QA document: W:\\Project\\ECI\\Fresno RIPA\\Documentation\\QA_rel_age.docx
