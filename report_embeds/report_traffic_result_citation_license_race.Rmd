...
# create tooltip text
tooltip_text <- "Out of all <b>{point.statute_literal_25}</b> citations given out by Fresno PD, <b>{point.rate:.1f}%</b> were given to people perceived as <b>{point.race_label}</b>, or a total of <b>{point.count:.1f}</b> people cited."
