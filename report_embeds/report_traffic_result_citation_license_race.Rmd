...
chart<-rdaStackedBar(
  ...
  "rate",
  "race_label",
  bar_colors=list("#949494", "#DEDEDE", "#FFE8B3", "#FED163", "#FDB913"),
  theme="theme_fbhc",
  title =  paste("Fresno PD gives  ", "<span style='color:#FDB913;'>75%</span>", "of their Citations for Driving Without a License to People of Color"),
