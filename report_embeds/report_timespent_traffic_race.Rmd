...
ois_traffic_race<-ois_traffic_race%>%
  mutate(bipoc=ifelse(nh_race=='nh_white','Persons Perceived as White','Persons of Color'))%>%
    mutate(bipoc_label=ifelse(nh_race=='nh_white','White','a Person of Color'))%>%
  mutate(bipoc_flag=ifelse(bipoc=='People of Color',1,0))
