...
hchart(df_pop,
 ...
 hc_xAxis(
    categories = list("Black", "Latinx", "SWANA/SA", "White", 
                      "Asian", "NHPI", "AIAN", "Multiracial")
  )%>%
  ...
  hc_plotOptions(bar = list(stacking = "rate")) %>%
    ...
    hc_title(text = "Fresno PD Disproportionately Burdens Black People in Fresno with Traffic Stops Across all Stop Types") %>%

    hc_subtitle(text = "Percent of officer-initiated traffic stops by traffic stop type and perceived race per 1k of total population") %>%
