...
highchart() %>%
  ...
  # Revert to the original event handling for initial visibility
  ...
  hc_chart(
    marginRight = 120,
    height = 480,
    spacingBottom = 40,  # Add extra space at bottom
    reflow = FALSE  # Prevent automatic reflowing
  ) %>%
  ...
  hc_subtitle(text = "Officer-initiated traffic stops by traffic stop type and perceived race per 1K people of same race") %>%
