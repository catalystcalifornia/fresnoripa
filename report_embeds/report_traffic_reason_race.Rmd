...
chart_race<-rdaGroupedBar(
  ...
  "rate",
  "statute_literal_25",
  title = "Fresno PD Stops BIPOC People in Traffic Stops for Reasons That Do Not Require Policing",
...
browsable(
  tagList(
    tags$h2("Fresno PD Stops People Perceived as BIPOC in Traffic Stops for Reasons Not Related to Safety at Higher Rates than People Perceived as White"),  # Main title
