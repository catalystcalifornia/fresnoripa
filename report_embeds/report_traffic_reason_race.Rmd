...
# create tooltip text
tooltip_text <- "Out of all the people Fresno PD stopped for traffic reasons and perceived as <b>{point.race_label}</b>, <b>{point.rate:.1f}%</b> of those people were stopped for <b>{point.statute_literal_25}</b>, or a total of <b>{point.count:.1f}</b> people."
...
list_of_plots <- map(unique(df_final$statute_literal_25), function(x) {
  ...
  hc_exporting(
      ...
      filename = paste0("Percent of traffic stops by traffic reason and race","_Catalyst California, catalystcalifornia.org, ", format(Sys.Date(), "%Y"), "."),
...
browsable(
  tagList(
    tags$text("Officers are biased in when they stop people for reasons not related to public safety", # Main title
