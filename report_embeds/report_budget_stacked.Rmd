...
category=c("General Fund Operating Budget", "General Fund Operating Budget", "Total Budget", "Total Budget"),

color=c("#FDB913", "#053451","#FDB913", "#053451")
)
...
title <- "Fresno PD is allocated 12 times more General Operating Funds than Parks, Libraries, and other Community Programs combined "

subtitle <-"FY25 Proposed Budget Allocation Comparative Analysis for Police versus PARCS"

# create tooltip text

tooltip_text <- "Fresno city is proposing to allocate <b>${point.budget:,.0f}</b> in <b>{point.category}</b> funding to <b>{point.fundee}</b> in FY2025."
