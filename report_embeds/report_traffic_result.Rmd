...
tooltip_text <- "Out of 100 traffic stops made by Fresno PD,  <b>{point.rate:.1f}%</b> resulted in <b>{point.stop_result_simple}</b>, or a total of <b>{point.count:.0f}</b> stops."
