...
tooltip_text <- "Out of 100 officer-initiated traffic stops,  <b>{point.rate:.1f}%</b> of those stops resulted in <b>{point.stop_result_simple}</b>, or a total of <b>{point.count:.1f}</b> stops."
