...
chart_race_gender<-rdaGroupedBar(df,"race_label","traffic_race_rate","gender",bar_colors=list(meteorite,lavender),title="Fresno PD Stops a Higher Share of Men of Color During Traffic Stops",
