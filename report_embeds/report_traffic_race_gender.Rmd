...
df<-df_p%>%filter(race %in% c("nh_white","latinx","nh_asian","aian","nhpi","nh_multiracial","nh_black","sswana"))%>%
  ...
  arrange(gender,traffic_race_rate)%>%
...
methodnote <- "Analysis for all officer-initiated traffic stops made by officers in 2022. Officers stopped a total of 6 individuals perceived as transgender or gender non-conforming. 67% of these people were perceived as Latinx."
...
chart_race_gender<-rdaGroupedBar(df,"race_label","traffic_race_rate","gender",bar_colors=list(lavender,meteorite),title="Fresno PD Stops a Higher Share of Men of Color During Traffic Stops",
