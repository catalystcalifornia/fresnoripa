...
In 2022, Fresno PD conducted 90 searches, and searched a total of 106 people. Out of those 90 searches, 62 did not yield any contraband, or 68.9%, while __only 28 searches yielded any contraband, or 31.1% of searches__. 
...
df<-search%>%
  ...
  group_by(search)%>%
  summarise(Count = n(),
             person_count=sum(persons_count),
            .groups = 'drop') 
