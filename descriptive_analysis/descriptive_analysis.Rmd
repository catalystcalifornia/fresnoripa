...
# graph: I don't know if this is worth showing I don't think the disparity is that high or compelling of a story but open to other thoughts
...
ggplot(df0, aes(x = statute_literal_25, y = rate))+
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=0.5, size=6), #aesthetics of the barchart
        ...
        panel.grid.minor = element_blank(),
panel.background = element_blank())+
  facet_wrap(. ~ Race, ncol=5, scales = 'free') 
...
### Stop reasons for moving traffic stops
