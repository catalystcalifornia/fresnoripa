...
dbWriteTable(con,  "report_citation_traffic_type_race", df_race,
             overwrite = TRUE, row.names = FALSE,
             field.types = charvect)
...
COMMENT ON COLUMN report_citation_traffic_type_race.rfs_traffic_violation_code IS 'Traffic stop resulting in a citation specific citation code';
